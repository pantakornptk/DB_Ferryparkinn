...
<div class="content-setting">
	<div class="setting-col" style="width:100%">
		<div class="setting-box">
			...
			<h4><span class="label label-primary"> การจองของฉัน</span> <span class="label label-warning text-black"></span></h4>
			<hr>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<span class="label label-success"><a class="link-noline txt-black" href="/main/bill/<?=$row["order_id"]?>">บิลใบเสร็จ</a></span>
						...
						<?php elseif($row["order_status"]=="deny"): ?>
						<td>
							<span class="label label-warning"><a class="link-noline txt-black" href="/main/payment/<?=$row["order_id"]?>">แจ้งชำระเงินอีกครั้ง</a></span>
							<span class="label label-danger"><a class="link-noline txt-black" href="/main/cancle/<?=$row["order_id"]?>">ยกเลิกจอง</a></span>
						</td>
						<?php endif; ?>
					</tr>
